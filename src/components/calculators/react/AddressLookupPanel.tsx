...
export default function AddressLookupPanel({
	...
	return (
		<section className="rounded-[1.8rem] border border-cyan-500/20 bg-[linear-gradient(180deg,rgba(14,165,233,0.08),rgba(2,6,23,0.9))] p-5 shadow-[0_0_34px_rgba(34,211,238,0.06)]">
			...
			<div className="mt-5 grid gap-4 xl:grid-cols-[minmax(0,1.15fr)_minmax(17rem,0.85fr)]">
					...
					<label className="grid gap-3">
						...
						<div className="flex flex-col gap-3 sm:flex-row">
							...
							<button
								...
								className="rounded-[1rem] border border-cyan-400/25 bg-cyan-400/10 px-4 py-3 text-sm font-semibold text-cyan-100 transition hover:bg-cyan-400/15 disabled:cursor-wait disabled:opacity-70"
							>
				...
				<div className="grid grid-cols-[repeat(auto-fit,minmax(11rem,1fr))] gap-3">
					<div className="rounded-[1.15rem] border border-slate-800 bg-slate-950/55 p-4">
						<p className="font-mono text-[0.66rem] uppercase tracking-[0.22em] text-slate-500">ZIP</p>
					...
					<div className="rounded-[1.15rem] border border-slate-800 bg-slate-950/55 p-4">
						<p className="font-mono text-[0.66rem] uppercase tracking-[0.22em] text-slate-500">Size</p>
						<p className="mt-3 text-xl font-semibold tabular-nums text-white">
					...
					<div className="rounded-[1.15rem] border border-slate-800 bg-slate-950/55 p-4">
						<p className="font-mono text-[0.66rem] uppercase tracking-[0.22em] text-slate-500">AVM</p>
						<p className="mt-3 text-xl font-semibold tabular-nums text-white">
					...
					<div className="rounded-[1.15rem] border border-slate-800 bg-slate-950/55 p-4">
						<p className="font-mono text-[0.66rem] uppercase tracking-[0.22em] text-slate-500">Comp ARV</p>
						<p className="mt-3 text-xl font-semibold tabular-nums text-white">
