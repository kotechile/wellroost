...
generated_at: "2026-05-18T19:55:36.033Z"
...
Reading order detected on the source: `feature-grid → hero → feature-grid → feature-grid → nav → nav → nav → nav → nav → feature-grid → feature-grid → hero → hero → feature-grid → hero → sidebar → nav → testimonial → feature-grid → feature-grid → footer → nav`.
...
**Neutrals:** `#171717` · `#ebebeb` · `#4d4d4d` · `#fafafa` · `#666666`
...
**Layout primitives:** 56 grid containers · 501 flex containers.
...
- Don't 1194 !important rules — prefer specificity over overrides.
- Don't 11530 duplicate css declarations.

---
_Generated by [designlang](https://github.com/Manavarya09/design-extract) v12.1.0 from <https://vercel.com>._
